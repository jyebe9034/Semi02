	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="photo_image/bestgift.jpg"  class="d-block w-100 img_carousel"
					alt="...">
			</div>
...
<!-- 		</div> -->
				...
				<div class="container">
               		<div class="row">
                        <div class="step1 col-lg-3 col-md-6 col-sm-6 col-xs-6" style="background-color:#8be1ef">
                        	<h1>1</h1><h4>후원 요청 글과 함께 은행명, 계좌번호를 입력하면</h4>
                        </div>
                        <div class="step2 col-lg-3 col-md-6 col-sm-6 col-xs-6" style="background-color:#60d6ea">
                    		<h1>2</h1><h4>후원 게시판에 글이 등록이 되고</h4>
                        </div>
                        <div class="step3 col-lg-3 col-md-6 col-sm-6 col-xs-6" style="background-color:#3bd3ed;">
       						<h1>3</h1><h4>후원자분들이 기부금을 결제하면</h4>
                        </div>
                        <div class="step4 col-lg-3 col-md-6 col-sm-6 col-xs-6" style="background-color:#1ebdd8;">
       						<h1>4</h1><h4>모금 마감일에 모금액 전액이 일괄적으로 후원 요청자분께 전달됩니다.</h4>
                        </div>
                 	</div>
                  </div>
				...
				<div class="container container_card">
                   <div class="row rowcard">
                        <div class="card col-lg-4 col-md-12 col-sm-12">
                            ...
                            <div class="card-body">
                                <h6 class="card-title"><span id="title1"></span></h6>
                                <hr><p class="card-text" align="left">
                              		모금 마감일 <br><span id="dueDate1"></span><br><p></p>모금현황<br>
                        ...
                        <div class="card col-lg-4 col-md-12 col-sm-12">
                            <div id="imgBox2" class="imgBox"> <img src="" class="card-img-top" alt="..."></div>
                            <div class="card-body">
                                <h6 class="card-title"><span id="title2"></span></h6>
                                <hr><p class="card-text">
                              		  모금 마감일 <br><span id="dueDate2"></span> <br><p></p>모금현황<br>
                        ...
                        <div class="card col-lg-4 col-md-12 col-sm-12">
                            <div id="imgBox3" class="imgBox"><img src="" class="card-img-top" alt="..."></div>
                            <div class="card-body">
                                <h6 class="card-title"><span id="title3"></span></h6>
                                <hr><p class="card-text">
                                	 모금 마감일 <br><span id="dueDate3"></span><br><p></p>모금현황<br>
 					 ...
 					 <h1 class="display-4">2019년 도움닿기 후원 현황</h1>
  					 <p class="lead"><h2>여러분의 사랑이 이렇게 모아졌습니다.</h2><br><h2><span id="amount"></span></h2><br><h2>현재 후원자수 : <span id="countDonors"></span></h2></p>
 					 <hr class="my-4">
  					</div>
